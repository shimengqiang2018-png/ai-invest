...
感谢你对 AI Invest 的关注。这个项目起点是我个人的投资研究流程，开源出来是希望方法论对更多人有用。为了让维护可持续，请在提交 issue 或 PR 前花两分钟读完这份指南。
...
Thanks for your interest in AI Invest. This project grew out of my personal investment research workflow; it is open-sourced so the methodology can be useful to others. Please read this short guide before opening an issue or PR.
