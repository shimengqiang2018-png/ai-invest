...
For long-form AI Invest outputs, title the artifact as a "research report" by default. Use "investment memo" only when the user explicitly asks for a memo format.
...
For AI Invest company reports, use this order unless the user asks otherwise:
...
For AI Invest work, pair especially with:
