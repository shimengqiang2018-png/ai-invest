...
# AI Invest - AI 时代的价值投资研究框架

> "Price is what you pay, value is what you get." — Warren Buffett
>
> 用 AI 重新定义投资研究的深度与效率。

**AI Invest** 是一套同时兼容 Claude Code 与 Codex 的投资研究 Skill 合集，将巴菲特、芒格、段永平、李录四位价值投资大师的方法论系统化、结构化，通过 AI Agent 实现专业级投资研究。
...
AI Invest 解决的不是"能不能分析"的问题，而是**分析质量和决策纪律**的问题。以下是核心差异：

### 1. 强制给结论，不打太极

直接问AI，你得到的是两面讨好的"分析"。AI Invest 强制输出：**通过/不通过/灰色地带**，带具体价格区间和分层建议。
...
AI最危险的不是给错答案，而是给一个**看起来很对但经不起推敲**的答案。AI Invest 在流程中内置了多层"防骗"机制：
...
**真实案例**：分析腾讯时，不同来源的市值数据有"港币亿"和"人民币亿"两种单位。AI Invest 的处理方式：
...
AI Invest 确保：**同样的输入 → 结构一致、深度一致的输出**。这意味着你可以：
- 7家公司横向对比，评分标准完全一致
- 同一家公司半年后重新分析，直接对比变化
- 团队成员之间的研究结果可以对齐
...
> **普通人问AI得到的是"看起来对的分析"，用 AI Invest 得到的是"可以拿来做决策的投研报告"。**
...
<p align="center">
  <img src="assets/architecture.svg" alt="AI Invest 整体架构" width="760" />
</p>
